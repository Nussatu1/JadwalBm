...
export default function EventFormPage({ initialData = null, onCancel, onSuccess }) {
  ...
  // memberAssignments: [{nama: string, peranAcara: string}]
  ...
  useEffect(() => {
    if (initialData) {
      ...
      // Parse format baru: "Nama:Peran" atau format lama: "Nama"
  ...
  // Toggle anggota dari daftar master
  ...
  const handleSubmit = async (e) => {
    ...
    setSubmitting(true);
    // Format output: "Nama:Peran" per anggota, pisah koma
    ...
    <div className="bg-white rounded-[8px] border border-[#E5E7EB] shadow-cf-card overflow-hidden">
      ...
      <form onSubmit={handleSubmit} className="p-4 sm:p-5 space-y-4 text-[13px]">
        ...
        <div className="border border-[#E5E7EB] rounded-[6px] p-3 bg-[#F6F6F7]">
          ...
          {/* Pilih dari daftar master anggota */}
          {anggota.length > 0 && (
          ...
          {/* Daftar anggota terpilih + input peran per acara */}
